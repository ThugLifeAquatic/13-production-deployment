...
const app = express();
// const conString = 'postgres://USERNAME:PASSWORD@HOST:PORT';DATABASE_URL ||'postgres://postgres:1Bash2Bash0110!:localhost:5432/kilovolt';||
const conString = 'DATABASE_URL'; // DONE: Don't forget to set your own conString
